...
|---|---|
| [`app.html`](frontend/app.html) | The full Dev Hub — searchable, progress, **429+ pages across 27 tracks grouped into categories** (incl. 🍳 *Common Recipes* — practical how-tos like API→form, batch upload, password complexity) (serve it; `index.html` redirects here) |
...
- **`frontend/`** — the hub app (`app.html`): **400+ interactive visualizers** across
  **25 tracks**, a searchable **two-level sidebar** (each track's pages are grouped into
  ...
  **🐿️ Go** (now with **web frameworks — Gin/Echo/Fiber**), a **🐘 PHP & Laravel** track (PHP's shared-nothing request
  ...
  (how the layers combine — SPA + REST/CIAM, MERN, server-rendered monoliths, compiled API + SPA), **⎈ Kubernetes**, **🗄️ SQL & Databases**, and a **⌨️ Shell & Scripting** track
...
> It maps the 25 tracks and hands you ready-made learning paths — including a featured
