...
|---|---|
| [`app.html`](frontend/app.html) | The full Dev Hub — searchable, progress, **509 pages across 34 tracks grouped into categories** (incl. 🍳 *Common Recipes* — practical how-tos like API→form, batch upload, password complexity — the 🟢 *Cloud — GCP*, 🌐 *Web Fundamentals*, 📊 *Data Science & ML*, 🧠 *AI/LLM Engineering*, and 🤖 *AI-Assisted Development* tracks — and 🧑‍💻 *Coding Practice (IDE)*, a real graded-exercise track: write JS/TS/Python, run it for real in your browser, pass/fail against hidden tests) (serve it; `index.html` redirects here) |
...
- **`frontend/`** — the hub app (`app.html`): **509 interactive visualizers** across
